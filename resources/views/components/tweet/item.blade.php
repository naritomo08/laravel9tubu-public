...
<li class="border-b last:border-b-0 border-gray-200 p-4 flex items-start justify-between" data-tweet-id="{{ $tweet->id }}" data-tweet-updated-at="{{ $tweet->updated_at->toJSON() }}">
    <div>
